...
import { Zap, Shield, Sparkles, Bot } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={onEnter}
        className="mt-10 px-8 py-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium text-sm shadow-[0_0_20px_rgba(124,58,237,0.4)] hover:shadow-[0_0_30px_rgba(124,58,237,0.6)] transition-shadow"
      >
        شروع کنید
      </motion.button>
    </motion.div>
